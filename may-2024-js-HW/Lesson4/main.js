...
function areaOfARectangleOrSquare (a, b){
...
console.log(areaOfARectangleOrSquare('gfjh', 20));
...
function outputOfArrayElements (arr){
...
function createsTagParagraphWithText (text) {
...
function creatingAPersonalList (text, number) {
...
function creatingAListOfArrayElements (array) {
...
function creatingAListUsers (array) {
    if (Array.isArray(array)) {
        for (const element of array) {
...
function returnTheSmallestNumberFromTheArray (array) {
    if (Array.isArray(array)) {
